...
export function Footer() {
  return (
    <footer className="bg-[#1A0F38] text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/services" className="text-gray-400 hover:text-accent transition-colors text-sm">Our Services</Link></li>
              <li><Link to="/gallery" className="text-gray-400 hover:text-accent transition-colors text-sm">Gallery</Link></li>
              <li><Link to="/booking" className="text-gray-400 hover:text-accent transition-colors text-sm">Book an Event</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="text-gray-400 text-sm">Event Decoration</li>
              <li className="text-gray-400 text-sm">Food Catering</li>
              <li className="text-gray-400 text-sm">Drinks & Bar Setup</li>
              <li className="text-gray-400 text-sm">Rentals</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400 text-sm">Minna, Niger State, Nigeria</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-accent shrink-0" />
                <a href="tel:09165315436" className="text-gray-400 hover:text-white transition-colors text-sm">09165315436</a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-accent shrink-0" />
                <a href="mailto:eventmart.ng@gmail.com" className="text-gray-400 hover:text-white transition-colors text-sm break-all">eventmart.ng@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
